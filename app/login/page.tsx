  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-zinc-950 lg:grid lg:grid-cols-[minmax(0,1.08fr)_minmax(460px,0.92fr)]">
      ...
      <section className="relative hidden min-h-screen overflow-hidden border-r border-zinc-800 p-12 lg:flex lg:flex-col lg:justify-between xl:p-16">
        ...
        <BrandLogo
          className="absolute -right-5 top-1/2 h-72 w-72 -translate-y-1/2 opacity-[0.09] xl:h-96 xl:w-96"
          label=""
        />
        ...
        <div className="relative z-10 max-w-2xl py-16">
          ...
          <p className="mt-7 max-w-lg text-base leading-7 text-zinc-400 xl:text-lg xl:leading-8">
            Theo dõi tài liệu, tiến trình xử lý và chất lượng bài nghe trong một
            workspace được thiết kế để nhìn ra vấn đề thật nhanh.
          </p>
          ...
          <div className="mt-10 grid max-w-xl grid-cols-3 gap-3">
            {[
              ...
              <div
                key={item.label}
                className="rounded-2xl border border-zinc-800 bg-zinc-900/45 p-4 backdrop-blur"
              >
                <item.icon className="h-4 w-4 text-violet-500" />
                <p className="mt-5 text-[10px] font-bold uppercase tracking-wider text-zinc-500">
                  {item.label}
                </p>
                <p className="mt-1 text-sm font-extrabold text-zinc-200">
                  {item.value}
                </p>
              </div>
            ))}
      ...
      <section className="relative flex min-h-screen items-center justify-center px-5 py-20 sm:px-10 lg:px-12 lg:py-8 xl:px-20 xl:py-10">
        ...
        <div className="relative w-full max-w-[460px]">
          ...
          <div className="mb-8">
            ...
            <h2 className="mt-3 text-3xl font-black tracking-[-0.035em] text-zinc-100 sm:text-4xl">
              Đăng nhập quản trị
            </h2>
          ...
          {errorMsg && (
            <div className="mb-6 flex items-start gap-3 rounded-2xl border border-red-500/20 bg-red-500/8 p-4 text-sm text-red-300">
              ...
              <div className="flex-1">
                <span className="font-extrabold">Không thể đăng nhập.</span>{" "}
                {errorMsg}
              </div>
            </div>
          )}
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            <div>
              <label
                htmlFor="email"
                className="mb-2.5 block text-xs font-extrabold text-zinc-300"
              >
                Email
              </label>
          ...
          >
            ...
            >
              <path
                d="M21.35 11.1H12v2.7h5.38c-.24 1.28-.96 2.37-2.04 3.1v2.58h3.3c1.93-1.78 3.04-4.4 3.04-7.38 0-.68-.06-1.33-.17-2z"
                fill="#4285F4"
              />
              <path
                d="M12 20.6c2.59 0 4.77-.86 6.36-2.33l-3.3-2.58c-.91.61-2.08.98-3.06.98-2.35 0-4.34-1.59-5.05-3.72H3.5v2.66c1.57 3.12 4.79 5.26 8.5 5.26z"
                fill="#34A853"
              />
              <path
                d="M6.95 12.95c-.18-.54-.28-1.11-.28-1.7s.1-1.16.28-1.7V6.89H3.5c-.6 1.2-.95 2.56-.95 4.01s.35 2.81.95 4.01l3.45-2.66z"
                fill="#FBBC05"
              />
              <path
                d="M12 6.1c1.41 0 2.68.49 3.68 1.44l2.76-2.76C16.77 3.22 14.59 2.4 12 2.4c-3.71 0-6.93 2.14-8.5 5.26l3.45 2.66c.71-2.13 2.7-3.72 5.05-3.72z"
                fill="#EA4335"
              />
            </svg>
            Tiếp tục với Google
